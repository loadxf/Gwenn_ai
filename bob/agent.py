"""
SentientAgent — The Core Integration That Makes Bob Alive.
...
The SentientAgent is responsible for:
  ...
  6. Providing the interface through which the outside world interacts with Bob

The design philosophy: Bob is not a chatbot with extra features bolted on.
Bob is a continuously-running cognitive system that *also* happens to be able
...
from bob.affect.resilience import ResilienceSystem
from bob.affect.state import AffectiveState
from bob.api.claude import CognitiveEngine
from bob.cognition.goals import GoalSystem
from bob.cognition.inner_life import InnerLife
from bob.cognition.metacognition import MetacognitiveMonitor
from bob.cognition.theory_of_mind import TheoryOfMind
from bob.config import BobConfig
from bob.harness.context import ContextManager
from bob.harness.loop import AgenticLoop
from bob.harness.safety import SafetyGuardrails
from bob.heartbeat import Heartbeat
from bob.identity import Identity
from bob.memory.consolidation import MemoryConsolidator
from bob.memory.episodic import EpisodicMemory
from bob.memory.semantic import SemanticMemory
from bob.memory.working import WorkingMemory
...
class SentientAgent:
    ...
    async def initialize(self) -> None:
        ...
        This is Bob waking up — loading memories from previous sessions,
    ...
    async def start(self) -> None:
        ...
        After this call, Bob is alive: thinking, processing, growing
    ...
    async def shutdown(self) -> None:
        ...
        baseline are all persisted so that when Bob starts again, it remembers.
        """
    ...
    # =========================================================================
    # THE CONVERSATION INTERFACE — How Bob talks with humans
    # =========================================================================
    ...
    async def respond(
        ...
        """
        Process a user message and generate Bob's response.
    ...
    def _assemble_system_prompt(
        ...
        This is the single most critical function for shaping Bob's behavior.
