"""
Memory Store — Bob's Persistence Layer.
...
Bob continuity across sessions — the ability to wake up and remember.
...
from bob.memory.episodic import Episode
...
class MemoryStore:
    ...
    def save_persistent_context(self, content: str, path: Optional[Path] = None) -> Path:
        """
        Save the persistent context file — Bob's equivalent of CLAUDE.md.
