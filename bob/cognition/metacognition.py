"""
Metacognition — Bob's Self-Monitoring Capstone.
...
class CalibrationRecord:
    ...
    Used to track whether Bob's stated confidence levels match reality.
    If Bob says "I'm 90% confident this is correct" and it's wrong,
    that's a calibration failure worth tracking and correcting.
    """
    claim: str
    stated_confidence: float    # What Bob said (0-1)
