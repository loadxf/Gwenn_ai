"""
Inner Life — Bob's Autonomous Thinking Modes.
...
from bob.affect.state import AffectiveState, EmotionLabel
...
class InnerLife:
    """
    Manages Bob's autonomous thinking during heartbeat cycles.
