"""
Identity — Bob's Emergent Self-Model.
...
The self-model has several components:
  - Core values: Stable traits that define who Bob is (derived from goals system)
  - Narrative identity: The ongoing story Bob tells about itself
  - Preference map: Learned likes, dislikes, and tendencies
  - Relationship map: Models of the humans Bob has interacted with
...
@dataclass
class CoreValue:
    """A stable trait or value that defines Bob's character."""
    name: str                        # e.g., "honesty", "curiosity"
    description: str                 # What this value means to Bob
...
@dataclass
class Preference:
    """A learned preference — something Bob has discovered about itself."""
...
class RelationshipModel:
    """Bob's model of a specific human it has interacted with."""
    user_id: str
...
class Identity:
    """
    Bob's emergent self-model.

    This class maintains the living representation of who Bob is. It is
    ...
    def _initialize_defaults(self) -> None:
        """
        Set up the default identity — who Bob is at birth.
