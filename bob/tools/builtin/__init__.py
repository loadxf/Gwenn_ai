"""
Built-in Tools — Bob's Native Capabilities.

These are the tools that ship with Bob and don't require external MCP servers.
...
def register_builtin_tools(registry: ToolRegistry) -> None:
    ...
    registry.register(ToolDefinition(
        ...
        description=(
            ...
            "response text, think_aloud is explicitly framed as Bob's internal "
