"""
Tool Registry — Bob's Catalog of Capabilities.

Every tool Bob can use is registered here with its JSON Schema definition,
...
class ToolRegistry:
    """
    Central registry for all tools available to Bob.
