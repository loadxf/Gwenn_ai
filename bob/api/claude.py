"""
Claude API Client — Bob's Cognitive Engine Interface.
...
from bob.config import ClaudeConfig
...
class CognitiveEngine:
    """
    Wraps the Anthropic Messages API to provide Claude as Bob's thinking substrate.
    ...
    async def think(
        ...
        """
        Generate a response — this is Bob having a thought.
