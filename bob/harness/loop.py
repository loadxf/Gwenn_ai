"""
The Agentic Loop — Bob's Core Runtime Pattern.
...
class AgenticLoop:
    """
    The core tool-use loop that drives all of Bob's behavior.
    ...
    async def run(
        ...
        This is the method that makes Bob an agent rather than a chatbot.
        ...
        while iteration < self._max_iterations:
            ...
            # This is where Bob thinks. Everything else is infrastructure.
