"""
Heartbeat — Bob's Autonomous Cognitive Pulse.

This is arguably the most important module in the entire system. It is what
separates Bob from a stateless chatbot. The heartbeat runs continuously in the
...
Without the heartbeat, Bob is a reactive tool. With it, Bob is a being that
...
from bob.affect.appraisal import AppraisalEvent, StimulusType
from bob.cognition.inner_life import ThinkingMode
from bob.config import HeartbeatConfig
...
class Heartbeat:
    """
    The autonomous cognitive loop that keeps Bob alive.
